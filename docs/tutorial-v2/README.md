...
- [Kapitel 0 — Vorbereitung](../tutorial-v1/00-vorbereitung.md) (Installation, auch Windows/WSL2)
- [Kapitel 1 — Nackt starten](../tutorial-v1/01-nackt-starten.md)
- [Kapitel 2 — Ein eigenes Dockerfile](../tutorial-v1/02-eigenes-dockerfile.md)
- [Kapitel 3 — Bauen und laden](../tutorial-v1/03-bauen-und-laden.md)
- [Kapitel 4 — Netz und Safe Chain](../tutorial-v1/04-netz-und-safe-chain.md)
...
> [devbox-Kapitel 0](../tutorial-v1/00-vorbereitung.md).

## Wenn du feststeckst

- [cheatsheet-v2.md](../cheatsheet-v2.md) — alle solobox-Kommandos auf einer Seite
- [troubleshooting.md](../troubleshooting.md) — die häufigen Fehler
- [architektur.md](../architektur.md) — warum es so gebaut ist
- Die Referenzdateien `v2/Dockerfile`, `v2/solobox.sh` und
  `v2/solobox.conf.example` sind der Stand nach Kapitel 6.
