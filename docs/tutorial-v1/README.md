...
Sieben Kapitel, plus eines zum Einrichten. Jedes endet in einem **lauffähigen
Zustand** — du kannst nach jedem Kapitel aufhören und hast etwas, das
funktioniert.
...
| --- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 0   | [Vorbereitung](00-vorbereitung.md)                           | `sbx` und Docker installiert haben — inkl. Windows/WSL2      |
...
docker --version # der LOKALE Docker — den braucht devbox zusätzlich zu sbx
git --version
```

Antwortet davon etwas nicht, oder ist dein Rechner überhaupt geeignet?
[Kapitel 0](00-vorbereitung.md) geht die Installation für macOS, Linux und
Windows durch.
...
> **Windows:** `devbox.sh` ist ein Bash-Skript und läuft nicht in PowerShell.
> Nutze **WSL2** — die Einrichtung steht in [Kapitel 0](00-vorbereitung.md).
